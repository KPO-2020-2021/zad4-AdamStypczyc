...
public:
    ...
    Prostopadloscian operator+(const Wektor3D translacja);
    void dlugosc(); //sprawdzanie długości boków po obrocie
    void wyswietl_wspolrzedne();
    Prostopadloscian &operator*(Macierz3x3 Macierz_obrotu); //mnożenie prostokąt razy macierz
    Prostopadloscian &operator*(double skala);
};
/*!
 ...
 * \return Zwraca wektor3D odpowiadający interesującej nas współrzędnej.
 */
const Wektor3D Prostopadloscian::operator[](int i) const
{
    return wspol[i];
}
/*!
 ...
 */
Prostopadloscian Prostopadloscian::operator+(const Wektor3D translacja)
{
    for (int i = 0; i < SZER; i++)
    {
 ...
 */
Prostopadloscian &Prostopadloscian::operator*(Macierz3x3 Macierz_obrotu)
{
    for (int i = 0; i < SZER; i++)
    {
        double _x = wspol[i][0];
        double _y = wspol[i][1];
        double _z = wspol[i][2];
        wspol[i][0] = _x * Macierz_obrotu(0, 0) + _y * Macierz_obrotu(0, 1) + _z * Macierz_obrotu(0, 2);
        wspol[i][1] = _x * Macierz_obrotu(1, 0) + _y * Macierz_obrotu(1, 1) + _z * Macierz_obrotu(1, 2);
        wspol[i][2] = _x * Macierz_obrotu(2, 0) + _y * Macierz_obrotu(2, 1) + _z * Macierz_obrotu(2, 2);
    }
    return *this;
}
/*!
 ...
 */
Prostopadloscian &Prostopadloscian::operator*(double skala)
{
    for (int i = 0; i < SZER; ++i)
    {
 ...
 */
void Prostopadloscian::wyswietl_wspolrzedne()
{
    std::cout << std::setw(20) << std::fixed << std::setprecision(10) << wspol[0] << std::endl;
    std::cout << std::setw(20) << std::fixed << std::setprecision(10) << wspol[1] << std::endl;
    std::cout << std::setw(20) << std::fixed << std::setprecision(10) << wspol[2] << std::endl;
    std::cout << std::setw(20) << std::fixed << std::setprecision(10) << wspol[3] << std::endl;
    std::cout << std::setw(20) << std::fixed << std::setprecision(10) << wspol[4] << std::endl;
    std::cout << std::setw(20) << std::fixed << std::setprecision(10) << wspol[5] << std::endl;
    std::cout << std::setw(20) << std::fixed << std::setprecision(10) << wspol[6] << std::endl;
    std::cout << std::setw(20) << std::fixed << std::setprecision(10) << wspol[7] << std::endl;
}
